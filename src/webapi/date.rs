...
impl Date {
    ...
    pub fn new_with_date(year: i32, month: i32, day: i32) -> Self {
        js!(
    ...
    /// [(JavaScript docs)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)
    // https://www.ecma-international.org/ecma-262/6.0/#sec-date-year-month-date-hours-minutes-seconds-ms
    pub fn new_with_time(year: i32, month: i32, day: i32, hours: i32, minutes: i32, seconds: i32) -> Self {
        js!(
    ...
    /// [(JavaScript docs)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)
    // https://www.ecma-international.org/ecma-262/6.0/#sec-date-year-month-date-hours-minutes-seconds-ms
    pub fn new_with_time_and_millis(year: i32, month: i32, day: i32, hours: i32, minutes: i32, seconds: i32, milliseconds: i32) -> Self {
        js!(
    ...
    pub fn new_with_string(date_string: &str) -> Self {
        js!(
    ...
    /// [(JavaScript docs)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)
    // https://www.ecma-international.org/ecma-262/6.0/#sec-date-value
    pub fn new_with_now(now: f64) -> Self {
        js!(
            return new Date(@{now});
        ).try_into().unwrap()
    }
...
fn test_date_get_date() {
    let now = Date::new_with_string("August 19, 1975 23:15:30");
...
fn test_date_get_full_year() {
    let now = Date::new_with_string("August 19, 75 23:15:30");
...
fn test_date_get_time() {
    let now = Date::new_with_string("July 20, 69 00:20:18 GMT+00:00");
...
fn test_date_get_timezone_offset() {
    ...
    let t1 = Date::new_with_string("August 19, 1975 23:15:30 GMT+07:00");
    let t2 = Date::new_with_string("August 19, 1982 23:15:30 GMT-02:00");
    assert_eq!(t1.get_timezone_offset(), t2.get_timezone_offset());
}

#[test]
fn test_date_get_utc_date() {
    let now = Date::new_with_string("August 19, 1975 23:15:30 GMT+11:00");
...
fn test_date_get_utc_full_year() {
    let now = Date::new_with_string("December 31, 1975 23:15:30 GMT+11:00");
...
fn test_date_to_date_string() {
    let now = Date::new_with_time(1993, 6, 28, 14, 39, 7);
    assert_eq!(now.to_date_string(), "Wed Jul 28 1993");
}

#[test]
fn test_date_to_iso_string() {
    let now = Date::new_with_string("05 October 2011 14:48 UTC");
    assert_eq!(now.to_iso_string(), "2011-10-05T14:48:00.000Z");
}

#[test]
fn test_date_to_json() {
    let now = Date::new_with_string("August 19, 1975 23:15:30 UTC");
...
fn test_date_to_utc_string() {
    let now = Date::new_with_now(Date::utc(96, 1, 2, 3, 4, 5, 0));
